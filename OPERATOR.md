...
### Knowledge layer: refresh + ask + search

```bash
# Re-survey the codebase after a build — the knowers re-run their scans and self-write their vaults (the accumulation command)
