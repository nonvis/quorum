...
inline int init_project() {
    ...
    std::cout << "     quorum --config .quorum/config.yaml agent create --role doer --name <name> --project .\n";
    std::cout << "  2. Start a conversation:\n";
    std::cout << "     quorum --config .quorum/config.yaml converse \"your goal\"\n";
    std::cout << "  Note: --config will be optional after Phase 3 task #1 (auto-discovery).\n";
